...
var Core = (function () {
    ...
    Core = __decorate([
        core_1.Component({
            ...
            directives: [sidebar_1.Sidebar, navbar_1.Navbar, chat_sidebar_1.ChatSidebar, router_deprecated_1.ROUTER_DIRECTIVES],
        ...
        __metadata('design:paramtypes', [config_1.ConfigService, core_1.ElementRef, router_deprecated_1.Router])
    ], Core);
    return Core;
}());
exports.Core = Core;
