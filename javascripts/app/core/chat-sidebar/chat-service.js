...
var ChatService = (function () {
    function ChatService() {
        ...
        this.todayConversations = [{
                ...
                image: '/static/images/people/a2.jpg',
                messages: [{
                        text: "Hey! What's up?"
                    }, {
                        text: "Are you there?"
                ...
                image: '/static/images/people/a1.jpg'
            }, {
                name: 'Jaron Fitzroy',
                status: 'gray-light',
                ...
                image: '/static/images/people/a4.jpg'
            }];
        this.lastWeekConversations = [{
                name: 'Freda Edison',
                status: 'gray-light',
                lastMessage: "Hey what's up? Me and Monica going for a lunch somewhere. Wanna join?",
                image: '/static/images/people/a6.jpg'
            }, {
                name: 'Livia Walsh',
                status: 'success',
                lastMessage: "Check out my latest email plz!",
                image: '/static/images/people/a5.jpg'
            }, {
                name: 'Jaron Fitzroy',
                status: 'warning',
                lastMessage: "What about summer break?",
                image: '/static/images/people/a3.jpg'
            }, {
                name: 'Mike Lewis',
                status: 'gray-light',
                lastMessage: "Just ain't sure about the weekend now. 90% I'll make it.",
