...
<div class="list-group-item bg-attention">
    <span class="thumb-sm pull-xs-left mr clearfix">
        <img class="img-circle" src="/static/images/people/a6.jpg" alt="...">
    </span>
...
<div class="list-group-item">
    <span class="thumb-sm pull-xs-left mr clearfix">
        <img class="img-circle" src="/static/images/people/a3.jpg" alt="...">
    </span>
    <p class="no-margin overflow-hidden">
...
<div class="list-group-item">
    <span class="thumb-sm pull-xs-left mr clearfix">
        <img class="img-circle" src="/static/images/people/a5.jpg" alt="...">
    </span>
    <p class="no-margin overflow-hidden">
